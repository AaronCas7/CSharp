...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Alumno first = new Alumno() { Nombre = "Aaron", Edad = 22 };
        Alumno second = first;
        ...
        Alumno alumno = new Alumno() { Nombre = "Aaron", Edad = 22};
        ...
        Alumno2 alumno2 = new Alumno2() { Nombre = "Aaron", Edad = 22 };
