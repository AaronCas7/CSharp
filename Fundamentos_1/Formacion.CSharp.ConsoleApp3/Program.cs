...
namespace Formacion.CSharp.ConsoleApp3
{
    class Program
    {
        ...
        static void Arrays()
        {
            ...
            array3[0] = new Alumno();
            array3[0].Nombre = "Aaron";

            array4a[0].Nombre = "Aaron";
        ...
        static void ArrayList()
        {
            ...
            array.Add(1);
            array.Add("borja");
            array.Add(new Alumno() { Nombre = "Aaron", Edad = 22 });
            array.Add(new { Nombre = "Aaron", Apellidos = "Castellano" });
        ...
        public static void AddItemReference()
        {
            ...
            var alumno = new Alumno() { Nombre = "Aaron", Edad = 22 };            
            alumnos.Add(alumno);
            ...
            alumnos2a.Add(new Alumno() { Nombre = "Aaron", Edad = 22 });
            ...
            {
                new Alumno() { Nombre = "Aaron", Edad = 22 },
            ...
            var item1 = new Alumno() { Nombre = "Aaron", Edad = 22 };
            alumnos2c.Add(item1);
